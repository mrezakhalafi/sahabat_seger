      ...
      <?= $this->session->flashdata('message'); ?>
        <div class="card shadow">
          <div class="card-header m-0 font-weight-bold txt-kirana">
            ...
            $angka2 = $_GET['id'];
            ?>
          <body onload="pilihdataPoktan(<?= $angka2 ?>);">
            <div class="card-body">
              <div class="col-lg-12">
                <div class="card border-top-kirana shadow h-100 py-2">
                  <div class="card-body" style="padding-bottom: 10px;">
                    <div class="row">
                      <div class="col-lg-6">
                        <form action="<?= base_url('poktan/ubah') ?>/?id=<?=$angka2?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col">
                              <div class="form-group">
                                <label for="id_staff"><strong>Staff :</strong></label>
                                  <select name="id_staff" class="form-control custom-select select2" id="id_staff" data-placeholder="Pilih Staff" data-multiple="false">
                              ...
                              <div class="col">
                                <div class="form-group">
                                  <label for="id_jenis_mitra"><strong>Jenis Mitra :</strong></label>
                                    <select name="id_jenis_mitra" class="form-control custom-select select2" id="id_jenis_mitra" data-placeholder="Pilih Mitra" data-multiple="false">
                              ...
                              <div class="col">
                                <div class="form-group">
                                  <label for="id_komuditi"><strong>Komuditi :</strong></label>
                                    <select name="id_komuditi" class="form-control custom-select select2" id="id_komuditi" data-placeholder="Pilih Komuditi" data-multiple="false">
                              ...
                              <div class="col">
                                <div class="form-group">
                                  <label for="id_prov"><strong>Provinsi :</strong></label>
                                    <select name="id_prov" id="id_prov" class="form-control custom-select action_wilayah select2" data-placeholder="Pilih Provinsi" data-multiple="false">
                              ...
                              <div class="col">
                                <div class="form-group">
                                  <label for="id_kab"><strong>Kabupaten :</strong></label>
                                    <select name="id_kab"  id="id_kab"  class="form-control custom-select action_wilayah select2" data-placeholder="Pilih Kabupaten" data-multiple="false">
                                      <option value="">Pilih Kabupaten</option>
                                        <?php foreach ($kab as $row6): ?>
                                          <option value="<?= $row6['id'] ?>" <?php echo set_select('id_kab',$row6['id']); ?> > <?= $row6['nama_kab'] ?></option>
                                        <?php endforeach; ?>
                                      </select>
                                ...
                                <div class="col">
                                  <div class="form-group">
                                    <label for="id_kec"><strong>Kecamatan :</strong></label>
                                      <select name="id_kec"  id="id_kec" class="form-control action_wilayah custom-select select2" data-placeholder="Pilih Kecamatan" data-multiple="false">
                                        <option value="">Pilih Kecamatan</option>
                                          <?php foreach ($kec as $row7): ?>
                                            <option value="<?= $row7['id'] ?>" <?php echo set_select('id_kec',$row7['id']); ?> > <?= $row7['nama_kec'] ?></option>
                                          <?php endforeach; ?>
                                          </select>
                                  ...
                                  <div class="col">      
                                    <div class="form-group">
                                      <label><strong>Rekening Bank : </strong></label>
                                        <select class="form-control custom-select select2" name="rek_bank" id="rek_bank" data-placeholder="Pilih Bank" data-multiple="false">
                                  ...
                                  <div class="form-group">
                                    <label><strong>Status : </strong></label>
                                      <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="aktifpoktan" name="aktif" class="custom-control-input" value="1" checked>
                                        <label class="custom-control-label" for="aktifpoktan">Aktif</label>
                                      </div>
                                      <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="nonaktifpoktan" name="aktif" class="custom-control-input" value="0">
                                        <label class="custom-control-label" for="nonaktifpoktan">Tidak Aktif</label>
                                      </div>          
                                    </div><br><br>
                                  </div>
                                </div>
                              <button type="submit" class="btn btn-kirana float-right ml-2">Ubah Data</button>
