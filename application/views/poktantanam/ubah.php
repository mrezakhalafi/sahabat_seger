...
$angka2 = $_GET['id'];
?>
<body onload="pilihdatapoktanTanam(<?= $angka2 ?>);">
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <?= $this->session->flashdata('message'); ?>
      <div class="card shadow">
        ...
        Ubah Data Poktan Tanam
        </div>
          <div class="card-body">
            <div class="col-lg-12">
              <div class="card border-top-kirana shadow h-100 py-2">
                <div class="card-body">
                  <form action="<?= base_url('poktantanam/ubahpoktantanam') ?>" method="post">
                    <div class="row">
                      <div class="col-lg-6">
                            ...
                            <div class="col">
                              <div class="form-group">
                                <label for="tgl_tanam"><strong>Tanggal Tanam :</strong></label>
                                  <input type="text" name="tgl_tanam" placeholder="01/09/2019" class="form-control" id="tgl_tanam" value="<?= set_value('tgl_tanam'); ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col">
                                  ...
                                  <div class="col">
                                    <label><strong>Pemupukan 1 : </strong></label>
                                      <div class="form-group">
                                        <input type="text" name="pemupukan1" class="form-control" value="<?= set_value('pemupukan1'); ?>" id="pemupukan1">
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <div class="row">
                                    <div class="col">
                                      <label><strong>Pemupukan 2 : </strong></label>
                                        <div class="form-group">
                                          <input type="text" name="pemupukan2" class="form-control" value="<?= set_value('pemupukan2'); ?>" id="pemupukan2">
                                      ...
                                      <div class="col-lg-6">
                                         <div class="form-group">
                                          <label><strong>Prediksi Tonase : </strong></label>
                                            <div class="form-group">
                                            <input type="text" name="prediksi_tonase" class="form-control" value="<?= set_value('prediksi_tonase'); ?>" id="prediksi_tonase">
                                ...
                                <div class="status_poktantanam">
                                  <div class="form-group">
                                    <label>Status : </label><br>
                                      <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="aktif_poktantanam" name="aktif" class="custom-control-input" value="1">
                                        <label class="custom-control-label" for="aktif_poktantanam">Aktif</label>
                                      </div>
                                      <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="nonaktif_poktantanam" name="aktif" class="custom-control-input" value="0">
                                        <label class="custom-control-label" for="nonaktif_poktantanam">Tidak Aktif</label>
                                      </div>          
                                    </div>
                                  </div>
                                </div>
