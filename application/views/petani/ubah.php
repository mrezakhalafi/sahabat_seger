  ...
  <div class="col-lg-12" style="padding: 0">
    ...
    <div class="card shadow">
      <div class="card-header m-0 font-weight-bold txt-kirana">
        ...
        $angka = $_GET['id'];
        ?>
          <body onload="pilihdataPetani(<?= $angka ?>);">
            <div class="card-body">
              <div class="col-lg-12">
                <div class="card border-top-kirana shadow h-100 py-2">
                  <div class="card-body">
                    <form action="<?= base_url('petani/ubahpetani') ?>/?id=<?=$angka?>" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label for="jns_kelamin_petani"><strong>Jenis Kelamin :</strong></label><br>
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="jns_kelamin_petani" name="jns_kelamin" class="custom-control-input" value="Laki-Laki" <?php echo set_radio('jns_kelamin', 'Laki-Laki'); ?>>
                                <label class="custom-control-label" for="jns_kelamin_petani">Laki - Laki</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="jns_kelamin_petani2" name="jns_kelamin" class="custom-control-input" value="Perempuan" <?php echo set_radio('jns_kelamin', 'Perempuan'); ?>>
                                <label class="custom-control-label" for="jns_kelamin_petani2">Perempuan</label>
                              </div>
                    ...
                    <label>Status : </label>
                      <div class="form-group">
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="aktifpetani" name="aktif" class="custom-control-input" value="1" checked>
                          <label class="custom-control-label" for="aktifpetani">Aktif</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" id="nonaktifpetani" name="aktif" class="custom-control-input" value="0">
                          <label class="custom-control-label" for="nonaktifpetani">Tidak Aktif</label>
                        </div>          
                      </div>
                    </div>
                  </div>
